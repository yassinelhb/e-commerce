           ...
           <div class="row" v-for="(product,index) in products" v-if="index < limit">
            <div class="col-md-3">
                ...
                <a :href="'/product/'+product.id">
                    <img class="img-fluid yl_prod_img" v-if="product.images.length" :src="'../img/'+product.images[0].path" >
                </a>
            </div>
            <div class="col-md-9">
    ...
    export default {
        ...
        methods: {
            getProducts(){
                ...
                if(this.sous_info){
                    this.type = this.sous_info
                }
                axios.get('/gestionproductsysltechno/'+this.categorie+'/'+this.tri+'/'+this.type)
                    .then(response => {
